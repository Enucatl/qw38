...
$(BUILD_DIR)/qw38-cuda-dispatch-tuning-test: cuda/dispatch_tuning_test.cu $(QUANT_MMV_CUDA_OBJECTS) | $(BUILD_DIR)
...
$(BUILD_DIR)/attention_decode.cuda.o: cuda/attention_decode.cu cuda/attention_decode.h cuda/fattn_mma_f16.cuh cuda/fattn_mma_f16_pipeline.cuh cuda/mma.cuh cuda/pdl_launch.cuh cuda/rms_norm.cuh | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) -Icuda -c $< -o $@
...
$(BUILD_DIR)/full_scheduler.cuda.o: cuda/full_scheduler.cu cuda/full_scheduler.h cuda/gdn_step.h cuda/pdl_launch.cuh cuda/rms_norm.cuh cuda/q8_decode_path.cuh cuda/ffn_decode_path.cuh cuda/attention_decode.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(CPPFLAGS) -Icuda -c $< -o $@

$(BUILD_DIR)/full_scheduler.trace.cuda.o: cuda/full_scheduler.cu cuda/full_scheduler.h cuda/gdn_step.h cuda/pdl_launch.cuh cuda/rms_norm.cuh cuda/q8_decode_path.cuh cuda/ffn_decode_path.cuh cuda/attention_decode.h | $(BUILD_DIR)
