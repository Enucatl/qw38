...
BUILD_DIR := build
LIB_SOURCES := src/status.cpp src/sha256.cpp src/model.cpp src/tokenizer.cpp src/template.cpp src/quant.cpp src/tensor.cpp src/conversion.cpp src/weights.cpp src/gdn.cpp src/attention.cpp src/engine.cpp
