...
$(BUILD_DIR)/attention_decode.cuda.o: cuda/attention_decode.cu cuda/attention_decode.h cuda/attention_decode_path.cuh cuda/fattn_mma_f16.cuh cuda/fattn_mma_f16_pipeline.cuh cuda/mma.cuh cuda/opt137_dense_mma_decode.cuh cuda/opt148_short_decode_flash.cuh cuda/pdl_launch.cuh cuda/rms_norm.cuh $(CUDA_STRICT_STAMP) | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) -Icuda $(NVCC_CUDA_DEPS) -c $< -o $@
