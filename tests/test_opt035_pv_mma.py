...
def opt034_037_not_started() -> bool:
    return (
        not (ROOT / "pins/opt034_packed_mmv_contract.json").is_file()
        and not (ROOT / "pins/opt037_ffn_tile_contract.json").is_file()
    )
