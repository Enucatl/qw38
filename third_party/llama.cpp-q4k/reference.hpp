// Relevant unmodified function bodies from llama.cpp e6ab7c1a4.
// Copyright (c) 2023-2026 The ggml authors; MIT license (see LICENSE).
// Standalone declarations/macros replace unrelated ggml build dependencies.
#pragma once
#include <cassert>
#include <cmath>
#include <cstdint>
#include <cstring>
namespace pinned_llama_q4k {
