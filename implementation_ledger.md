...
| OPT-128 | Remove measured host submission and synchronization stalls | OPT-125, OPT-127 | in_progress | Attributable host critical-path reduction with API semantics intact and full-request gates, or quantified no opportunity | [Dossier](tasks/OPT-128.md) |
