...
| OPT-122 | Evaluate lower-precision persistent GDN state with FP32 updates | OPT-115, OPT-116, OPT-118 | in_progress | At most two state encodings reduce storage/traffic and pass long recurrence, chunk/restore/graph and full-request gates, or retain FP32 with a measured disposition | [Dossier](tasks/OPT-122.md) |
