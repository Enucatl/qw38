...
| OPT-111 | Reproduce the remaining llama F16 MMA prompt-attention differences | OPT-079, OPT-103, OPT-106, OPT-114 | in_progress | A source-backed prompt-attention adapter, justified against the shipping OPT-079 `kv_once` control, improves complete attention and P4096 sufficiently to reduce the measured prefill gap while preserving exact causality and quality; otherwise no swizzle follow-up | [`tasks/OPT-111.md`](tasks/OPT-111.md) |
