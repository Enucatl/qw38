...
task in ledger/dependency order is OPT-086.
...
| OPT-109 | Keep transposed GDN state for the session lifetime | OPT-101, OPT-106, OPT-114 | done | Col-major device state persists across decode steps with no timed per-layer relayout; checkpoint/prompt boundaries round-trip canonically and complete GDN plus D128/D2048 improve, or sequential row-major remains | [`tasks/OPT-109.md`](tasks/OPT-109.md); [`pins/opt109_persistent_gdn_state_contract.json`](pins/opt109_persistent_gdn_state_contract.json); [`pins/opt109_iteration_contract.json`](pins/opt109_iteration_contract.json); [`fixtures/opt109_persistent_gdn_state.json`](fixtures/opt109_persistent_gdn_state.json); [`tools/opt109_persistent_gdn_state.py`](tools/opt109_persistent_gdn_state.py); [`tests/test_opt109_persistent_gdn_state.py`](tests/test_opt109_persistent_gdn_state.py); [`cuda/opt109_persistent_gdn_state_test.cu`](cuda/opt109_persistent_gdn_state_test.cu); [`cuda/gdn_decode_path.cuh`](cuda/gdn_decode_path.cuh); [`Makefile`](Makefile); [`evidence/optimization/opt109-persistent-gdn-state/REPORT.md`](evidence/optimization/opt109-persistent-gdn-state/REPORT.md); [`evidence/optimization/opt109-persistent-gdn-state/REJECTION.md`](evidence/optimization/opt109-persistent-gdn-state/REJECTION.md); verification 2026-09-12T23:25:00Z |
...
| OPT-117 | Repair and evaluate capture of complete decode segments | OPT-115, OPT-116 | done | Root-caused OPT-114 capture failure, same-arithmetic graph execution with dynamic-state/cancellation coverage, and complete-request keep/reject under shared gates | [`tasks/OPT-117.md`](tasks/OPT-117.md); [`pins/opt117_decode_segment_graphs_contract.json`](pins/opt117_decode_segment_graphs_contract.json); [`pins/opt117_iteration_contract.json`](pins/opt117_iteration_contract.json); [`fixtures/opt117_decode_segment_graphs.json`](fixtures/opt117_decode_segment_graphs.json); [`tools/opt117_decode_segment_graphs.py`](tools/opt117_decode_segment_graphs.py); [`tests/test_opt117_decode_segment_graphs.py`](tests/test_opt117_decode_segment_graphs.py); [`cuda/opt117_decode_segment_graphs_test.cu`](cuda/opt117_decode_segment_graphs_test.cu); [`Makefile`](Makefile); [`evidence/optimization/opt117-decode-segment-graphs/REPORT.md`](evidence/optimization/opt117-decode-segment-graphs/REPORT.md); verification 2026-09-13T14:27:54Z |
| OPT-118 | Remove avoidable host/device transfers and state materialization | OPT-115, OPT-116, OPT-117 | done | Lazy logits/hidden materialization plus decode D2H overlap on post113 `ffn_only`; complete-request D128/D2048 keep under OPT-115 gates with quality/state preserved | [`tasks/OPT-118.md`](tasks/OPT-118.md); [`pins/opt118_transfer_residency_contract.json`](pins/opt118_transfer_residency_contract.json); [`pins/opt118_iteration_contract.json`](pins/opt118_iteration_contract.json); [`fixtures/opt118_transfer_residency.json`](fixtures/opt118_transfer_residency.json); [`tools/opt118_transfer_residency.py`](tools/opt118_transfer_residency.py); [`tests/test_opt118_transfer_residency.py`](tests/test_opt118_transfer_residency.py); [`cuda/opt118_transfer_residency_test.cu`](cuda/opt118_transfer_residency_test.cu); [`Makefile`](Makefile); [`evidence/optimization/opt118-transfer-residency/REPORT.md`](evidence/optimization/opt118-transfer-residency/REPORT.md); verification 2026-09-13T15:06:00Z |
| OPT-119 | Reduce activation and prompt intermediate traffic across producer/consumer boundaries | OPT-115, OPT-116, OPT-118 | done | Mixer/FFN RMSNorm→MMQ Q8 fusion on post-OPT-118 `ffn_only`; 167772160 B BF16 reread removed; P4096 keep under OPT-115 gates with quality/state preserved | [`tasks/OPT-119.md`](tasks/OPT-119.md); [`pins/opt119_activation_pipeline_contract.json`](pins/opt119_activation_pipeline_contract.json); [`pins/opt119_iteration_contract.json`](pins/opt119_iteration_contract.json); [`fixtures/opt119_activation_pipeline.json`](fixtures/opt119_activation_pipeline.json); [`tools/opt119_activation_pipeline.py`](tools/opt119_activation_pipeline.py); [`tests/test_opt119_activation_pipeline.py`](tests/test_opt119_activation_pipeline.py); [`cuda/opt119_activation_pipeline_test.cu`](cuda/opt119_activation_pipeline_test.cu); [`Makefile`](Makefile); [`evidence/optimization/opt119-activation-pipeline/REPORT.md`](evidence/optimization/opt119-activation-pipeline/REPORT.md); verification 2026-09-13T15:32:42Z |
...
| OPT-125 | Reconcile decode timing, GPU activity and traffic evidence | OPT-123, OPT-124 | done | Corrected request/decode metrics; fresh A/A matched baseline P4096/D128/D2048 (0.966/0.801/0.692 vs llama decode-only); proven device-inactive 0 ms; 10 ms/token unobserved not proven inactive; D2048 0.620× does not survive matched boundaries; OPT-126/127/129 proceed; claims_throughput=false | [`tasks/OPT-125.md`](tasks/OPT-125.md); [`pins/opt125_decode_accounting_contract.json`](pins/opt125_decode_accounting_contract.json); [`pins/opt125_iteration_contract.json`](pins/opt125_iteration_contract.json); [`fixtures/opt125_decode_accounting.json`](fixtures/opt125_decode_accounting.json); [`tools/opt125_decode_accounting.py`](tools/opt125_decode_accounting.py); [`tests/test_opt125_decode_accounting.py`](tests/test_opt125_decode_accounting.py); [`cuda/opt125_decode_accounting_test.cu`](cuda/opt125_decode_accounting_test.cu); [`Makefile`](Makefile); [`evidence/optimization/opt125-decode-accounting/REPORT.md`](evidence/optimization/opt125-decode-accounting/REPORT.md); verification 2026-09-13T22:09:00Z |
| OPT-126 | Make decode graph inputs stable across token commits | OPT-125 | done | 56-byte `DecodeLaunchState`; `stable_pingpong_committed_slot` GDN; 16 segment graphs (8×2 topologies); same-math exact; prerequisite_verified; shipping selector unchanged `ffn_only`; claims_throughput=false | [`tasks/OPT-126.md`](tasks/OPT-126.md); [`pins/opt126_stable_graph_inputs_contract.json`](pins/opt126_stable_graph_inputs_contract.json); [`pins/opt126_iteration_contract.json`](pins/opt126_iteration_contract.json); [`fixtures/opt126_stable_graph_inputs.json`](fixtures/opt126_stable_graph_inputs.json); [`tools/opt126_stable_graph_inputs.py`](tools/opt126_stable_graph_inputs.py); [`tests/test_opt126_stable_graph_inputs.py`](tests/test_opt126_stable_graph_inputs.py); [`cuda/opt126_stable_graph_inputs_test.cu`](cuda/opt126_stable_graph_inputs_test.cu); [`cuda/decode_launch_state.cuh`](cuda/decode_launch_state.cuh); [`Makefile`](Makefile); [`evidence/optimization/opt126-stable-graph-inputs/INVENTORY.md`](evidence/optimization/opt126-stable-graph-inputs/INVENTORY.md); [`evidence/optimization/opt126-stable-graph-inputs/REPORT.md`](evidence/optimization/opt126-stable-graph-inputs/REPORT.md); verification 2026-09-13T23:06:00Z |
| OPT-127 | Replay decode segments without per-token recapture | OPT-126 | done | Recapture-free eight-layer segment replay on OPT-126 stable inputs; zero steady-state recapture; same-math exact; OPT-058 quality/state/memory pass; D128/D2048 request keep (geo 1.071/1.063); production pin `decode_segments8` | [`tasks/OPT-127.md`](tasks/OPT-127.md); [`pins/opt127_recapture_free_replay_contract.json`](pins/opt127_recapture_free_replay_contract.json); [`pins/opt127_iteration_contract.json`](pins/opt127_iteration_contract.json); [`fixtures/opt127_recapture_free_replay.json`](fixtures/opt127_recapture_free_replay.json); [`tools/opt127_recapture_free_replay.py`](tools/opt127_recapture_free_replay.py); [`tests/test_opt127_recapture_free_replay.py`](tests/test_opt127_recapture_free_replay.py); [`cuda/opt127_recapture_free_replay_test.cu`](cuda/opt127_recapture_free_replay_test.cu); [`cuda/execution_graph_path.cuh`](cuda/execution_graph_path.cuh); [`cuda/decode_launch_state.cuh`](cuda/decode_launch_state.cuh); [`Makefile`](Makefile); [`evidence/optimization/opt127-recapture-free-replay/REPORT.md`](evidence/optimization/opt127-recapture-free-replay/REPORT.md); verification 2026-09-13T23:55:00Z |
| OPT-128 | Remove measured host submission and synchronization stalls | OPT-125, OPT-127 | done | `no_material_opportunity`; parent `decode_segments8` unchanged; attributable upper bound 0.065 ms/token; host-stall pins dormant; OPT-125 state/memory pass; `claims_throughput=false` | [`tasks/OPT-128.md`](tasks/OPT-128.md); [`pins/opt128_host_stalls_contract.json`](pins/opt128_host_stalls_contract.json); [`pins/opt128_iteration_contract.json`](pins/opt128_iteration_contract.json); [`fixtures/opt128_host_stalls.json`](fixtures/opt128_host_stalls.json); [`tools/opt128_host_stalls.py`](tools/opt128_host_stalls.py); [`tests/test_opt128_host_stalls.py`](tests/test_opt128_host_stalls.py); [`cuda/opt128_host_stalls_test.cu`](cuda/opt128_host_stalls_test.cu); [`cuda/full_scheduler.h`](cuda/full_scheduler.h); [`cuda/full_scheduler.cu`](cuda/full_scheduler.cu); [`Makefile`](Makefile); [`evidence/optimization/opt128-host-stalls/REPORT.md`](evidence/optimization/opt128-host-stalls/REPORT.md); verification 2026-09-14T00:15:00Z |
| OPT-129 | Compare matched Quartz and llama decode-attention components | OPT-125 | done | `attention_material`; 18-shape matched replay (layers 3/7/63 × prefixes 128–32768); D2048 quartz 0.113 vs matched llama 0.029 ms/layer; 2 OPT-130 transfers ranked; OPT-130 disposition `proceed`; `hybrid_crossover@1024` unchanged; `claims_throughput=false` | [`tasks/OPT-129.md`](tasks/OPT-129.md); [`pins/opt129_matched_attention_contract.json`](pins/opt129_matched_attention_contract.json); [`pins/opt129_iteration_contract.json`](pins/opt129_iteration_contract.json); [`pins/opt129_matched_attention_provenance.json`](pins/opt129_matched_attention_provenance.json); [`fixtures/opt129_matched_attention.json`](fixtures/opt129_matched_attention.json); [`tools/opt129_matched_attention.py`](tools/opt129_matched_attention.py); [`tests/test_opt129_matched_attention.py`](tests/test_opt129_matched_attention.py); [`cuda/opt129_matched_attention_test.cu`](cuda/opt129_matched_attention_test.cu); [`cuda/opt129_llama_fattn_adapter.cuh`](cuda/opt129_llama_fattn_adapter.cuh); [`Makefile`](Makefile); [`tools/run_optimization_task.py`](tools/run_optimization_task.py); [`evidence/optimization/opt129-matched-attention/REPORT.md`](evidence/optimization/opt129-matched-attention/REPORT.md); verification 2026-09-14T00:36:00Z |
...
| OPT-139 | Normalize NCU evidence and authenticate production kernel identity | OPT-138 | done | Structured per-launch counters authenticate phase/workload/production dispatch; missing values and unsupported mechanisms remain explicit | Diagnostics only; D128 `warp_query` / D2048 `vec128_online` attn_core typed NCU counters with authenticated identity; mechanism unknown (no SASS); prefill ineligible OPT-140; `claims_throughput=false`; no production change; [`tasks/OPT-139.md`](tasks/OPT-139.md); [`tools/opt139_counter_identity.py`](tools/opt139_counter_identity.py); [`pins/opt139_counter_identity_contract.json`](pins/opt139_counter_identity_contract.json); [`pins/opt139_iteration_contract.json`](pins/opt139_iteration_contract.json); [`fixtures/opt139_counter_identity.json`](fixtures/opt139_counter_identity.json); [`tests/test_opt139_counter_identity.py`](tests/test_opt139_counter_identity.py); [`evidence/optimization/opt139-counter-identity/REPORT.md`](evidence/optimization/opt139-counter-identity/REPORT.md); verification 2026-09-14T23:36:43Z |
| OPT-140 | Add a production-boundary prefill attention replay | OPT-139 | done | Real P4096 attention replay matches production inputs, complete family boundary and outputs; decode substitution is rejected | Diagnostics only; P4096 prompt-attention replay 16/16 parity under abs 2e-3; decode-attention substitution rejected; bounded NCU `fattn_mma_pipeline_opt111_base` typed counters; mechanism unknown; `claims_throughput=false`; no production change; [`tasks/OPT-140.md`](tasks/OPT-140.md); [`tools/opt140_prefill_attention_replay.py`](tools/opt140_prefill_attention_replay.py); [`pins/opt140_prefill_attention_replay_contract.json`](pins/opt140_prefill_attention_replay_contract.json); [`pins/opt140_iteration_contract.json`](pins/opt140_iteration_contract.json); [`fixtures/opt140_prefill_attention_replay.json`](fixtures/opt140_prefill_attention_replay.json); [`tests/test_opt140_prefill_attention_replay.py`](tests/test_opt140_prefill_attention_replay.py); [`evidence/optimization/opt140-prefill-attention-replay/REPORT.md`](evidence/optimization/opt140-prefill-attention-replay/REPORT.md); verification 2026-09-15T00:06:52Z |
| OPT-141 | Collect matched llama counters for the selected gap families | OPT-139, OPT-140 | done | All four selected phase/family comparisons have authenticated llama launch mappings and matched counter evidence | Diagnostics only; four OPT-138 selections matched with authenticated llama launch mappings; typed NCU counters for decode attn D128/D2048 (`flash_attn_ext_vec`), residual (`quantize_q8_1`), prefill attn (`flash_attn_ext_f16`), prefill mmq (`mul_mat_q`); `llama_ncu_kernel_identity_unresolved=false`; fused-boundary mismatches explicit; mechanism unknown; `claims_throughput=false`; no production change; [`tasks/OPT-141.md`](tasks/OPT-141.md); [`tools/opt141_matched_llama_counters.py`](tools/opt141_matched_llama_counters.py); [`pins/opt141_matched_llama_counters_contract.json`](pins/opt141_matched_llama_counters_contract.json); [`pins/opt141_iteration_contract.json`](pins/opt141_iteration_contract.json); [`fixtures/opt141_matched_llama_counters.json`](fixtures/opt141_matched_llama_counters.json); [`tests/test_opt141_matched_llama_counters.py`](tests/test_opt141_matched_llama_counters.py); [`evidence/optimization/opt141-matched-llama-counters/REPORT.md`](evidence/optimization/opt141-matched-llama-counters/REPORT.md); verification 2026-09-15T00:31:30Z |
...
### 2026-09-11T17:28:23Z — OPT-075 Q4 production admission delivered
...
- Screened packed/paired_staged control, integer_q8 separate gate/up, and
  ...
  CI). Engine D2048+32 non-regression holds. Quality-v3 absolute fail, engine
  NR pass. Verdict: **retain_packed** / `missing_evidence`; shipping stays
  `packed` / `paired_staged`. Coupled IDs: none. No production pin change.
- Acceptance: host contract, three-config screen, all-leg dispatch proof,
  identity-cached quality, complete rotating/E2E evidence, and documented
  retain_packed decision; 12 pytest cases; scoped production overrides with
  separate graph capture.
- Acceptance evidence: [`tasks/OPT-075.md`](tasks/OPT-075.md);
  [`pins/opt075_q4_production_admission_contract.json`](pins/opt075_q4_production_admission_contract.json);
  [`pins/opt075_iteration_contract.json`](pins/opt075_iteration_contract.json);
  [`fixtures/opt075_q4_production_admission.json`](fixtures/opt075_q4_production_admission.json);
  [`tools/opt075_q4_production_admission.py`](tools/opt075_q4_production_admission.py);
  [`tests/test_opt075_q4_production_admission.py`](tests/test_opt075_q4_production_admission.py);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`cuda/q4k_decode_path.cuh`](cuda/q4k_decode_path.cuh);
  [`cuda/ffn_decode_path.cuh`](cuda/ffn_decode_path.cuh);
  [`cuda/optimization_component_replay.cu`](cuda/optimization_component_replay.cu);
  ...
  Proof is production admission with measured retain_packed decision — not a
  speedup gate. **tok/s delta vs packed baseline:** 0 (shipping unchanged).
- Marked OPT-075 `done`; delivery is limited to the verified task scope plus
  this ledger/audit bookkeeping. `plan.md` is unchanged. OPT-016 and OPT-056 stay
  `blocked`. Next eligible pending by dependency order: **OPT-076**. No tok/s
  claim (`claims_throughput=false`).

### 2026-09-11T17:52:00Z — OPT-076 Q4 late-reduction screen delivered

- Screened packed/paired_staged control and two Q8Block packed-load /
  late-reduction candidates (2 and 4 warps/row, paired_integer) on repaired
  OPT-071 captures. Numeric legacy and versioned production rules pass;
  OPT-074 Q4 families remain v2-unadmitted. Complete FFN acceptance n=10:
  packed 16.421 ms vs late_w4 9.818 ms (positive CI). Engine D2048+32
  non-regression holds. Quality-v3 absolute fail, engine NR pass. Verdict:
  **retain_packed** / `missing_evidence`; shipping stays `packed` /
  `paired_staged`. Coupled IDs: none. No production pin change. **OPT-075
  unaffected.**
- Acceptance: host contract, three-config screen, late-path dispatch proof,
  identity-cached quality, complete rotating/E2E evidence, and documented
  retain_packed decision; 10 pytest cases; native tiny/production numeric
  plus SASS/resource; no added spills.
- Acceptance evidence: [`tasks/OPT-076.md`](tasks/OPT-076.md);
  [`pins/opt076_q4_reduction_contract.json`](pins/opt076_q4_reduction_contract.json);
  [`pins/opt076_iteration_contract.json`](pins/opt076_iteration_contract.json);
  [`fixtures/opt076_q4_reduction.json`](fixtures/opt076_q4_reduction.json);
  [`tools/opt076_q4_reduction.py`](tools/opt076_q4_reduction.py);
  [`tests/test_opt076_q4_reduction.py`](tests/test_opt076_q4_reduction.py);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`cuda/q4k_decode_path.cuh`](cuda/q4k_decode_path.cuh);
  [`cuda/q4k_decode_dots.cuh`](cuda/q4k_decode_dots.cuh);
  [`cuda/q4k_decode_dots.cu`](cuda/q4k_decode_dots.cu);
  ...
  [`cuda/optimization_component_replay.cu`](cuda/optimization_component_replay.cu);
  [`cuda/optimization_engine_probe.cu`](cuda/optimization_engine_probe.cu);
  [`cuda/opt076_q4_reduction_test.cu`](cuda/opt076_q4_reduction_test.cu);
  [`Makefile`](Makefile);
  [`evidence/optimization/opt076-q4-reduction/REPORT.md`](evidence/optimization/opt076-q4-reduction/REPORT.md).
  Proof is measured retain_packed — not a shipping speedup. **tok/s delta vs
  packed baseline:** 0 (shipping unchanged).
...
### 2026-09-11T18:58:15Z — OPT-079 KV operand conversion reuse delivered

- Screened production `f16_async` against convert-once sibling `kv_once` on
  complete 16-layer P4096 attention. Native outputs equal the control
  (nonfinite 0); occupancy 1; local_bytes 0. Acceptance n=10: 249.697 vs
  238.189 ms; paired CI 11.476 .. 11.540 ms (saving 11.508 ms ≥ 5 ms). Engine
  five P4096 pairs: 1362.361 vs 1361.761 ms. Quality-v3 absolute fail, engine
  NR pass. Verdict: **keep**. Shipping pin is `kv_once`. Coupled IDs: none.
- Acceptance: host contract, 9 pytest cases, tiny/stage-lifetime/finite
  operands, 3+10 rotating complete attention, five engine pairs, decode
  guard, identity-cached OPT-073, and documented keep.
- Acceptance evidence: [`tasks/OPT-079.md`](tasks/OPT-079.md);
  [`fixtures/opt079_attention_kv_operands.json`](fixtures/opt079_attention_kv_operands.json);
  ...
  **tok/s delta vs f16_async P4096 engine baseline 3006.5 tok/s: +1.325
  (3007.9, 1.0004×).**
- Marked OPT-079 `done`; delivery is limited to the verified task scope plus
  this ledger/audit bookkeeping. `plan.md` is unchanged. OPT-016 and OPT-056
  stay `blocked`. Next eligible pending by dependency order: **OPT-078**.
  `claims_throughput=true`.

### 2026-09-11T19:08:00Z — OPT-078 decode query-prep screen delivered

- Screened two candidates (`prepared_q`, `prepared_q_veckv`) on decode-only
  one-warp/query-head Q prep plus optional 16-byte KV loads. Extra prep launch
  counted inside complete-attention timing; `n_parts=16`; native exact outputs.
  Acceptance n=10 complete 16-layer attention: control `warp_query` 9.092 ms vs
  `prepared_q` 10.315 ms; paired CI entirely negative. Engine D2048+32 NR pass.
  Quality identity-cached OPT-073. Verdict: **performance_rejected** /
  `negative_complete_saving`; production pin stays `warp_query`. Coupled IDs:
  none.
- Acceptance: host contract, 9 pytest cases, tiny/prod native proofs (refresh,
  candidate-KV boundary, alignment fallback), feedback d128/d2048, acceptance
  component+engine, identity-cached quality, and documented reject decision.
- Acceptance evidence: [`tasks/OPT-078.md`](tasks/OPT-078.md);
  [`pins/opt078_decode_attention_contract.json`](pins/opt078_decode_attention_contract.json);
  [`pins/opt078_iteration_contract.json`](pins/opt078_iteration_contract.json);
  [`fixtures/opt078_decode_attention.json`](fixtures/opt078_decode_attention.json);
  [`tools/opt078_decode_attention.py`](tools/opt078_decode_attention.py);
  [`tests/test_opt078_decode_attention.py`](tests/test_opt078_decode_attention.py);
  [`cuda/attention_decode_path.cuh`](cuda/attention_decode_path.cuh);
  [`cuda/attention_decode.cu`](cuda/attention_decode.cu);
  [`cuda/attention_decode.h`](cuda/attention_decode.h);
  [`cuda/opt078_decode_attention_test.cu`](cuda/opt078_decode_attention_test.cu);
  [`cuda/full_scheduler.h`](cuda/full_scheduler.h);
  [`cuda/full_scheduler.cu`](cuda/full_scheduler.cu);
  [`cuda/optimization_component_replay.cu`](cuda/optimization_component_replay.cu);
  [`cuda/optimization_component_replay.h`](cuda/optimization_component_replay.h);
  ...
  [`Makefile`](Makefile);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`evidence/optimization/opt078-decode-attention/REPORT.md`](evidence/optimization/opt078-decode-attention/REPORT.md).
  Proof is measured performance_rejected — not a shipping speedup. **tok/s delta
  vs then-current warp_query baseline:** 0 (shipping unchanged).
- Marked OPT-078 `done`; delivery is limited to the verified task scope plus
  this ledger/audit bookkeeping. `plan.md` is unchanged. OPT-016 and OPT-056 stay
...
### 2026-09-11T20:54:00Z — OPT-081 kernel parity policy reset delivered

- Froze host-only `kernel_parity_v1` as the active kernel-admission authority.
  Canonical C++ and Python checkers agree on 11 synthetic vectors. Association
  OR-rule, same-math bit identity, nonfinite rejection, and per-family
  abs-scale/rel-tol are encoded in
  [`pins/kernel_parity_v1_contract.json`](pins/kernel_parity_v1_contract.json).
  Future keep contracts requiring `opt074_coverage_unadmitted` fail closed
  except historical OPT-070/075/076 fixtures. Historical OPT-059/074 verdict
  content is unchanged; successor note lives on the OPT-081 contract and report.
  No kernel, production pin, or selector change. Coupled IDs: none.
- Acceptance: 15 pytest cases, feedback/acceptance policy phases (host_only,
  skip_compile, product=11), and manual verification checklist in
  [`tasks/OPT-081.md`](tasks/OPT-081.md).
- Acceptance evidence: [`tasks/OPT-081.md`](tasks/OPT-081.md);
  [`pins/kernel_parity_v1_contract.json`](pins/kernel_parity_v1_contract.json);
  [`pins/opt081_iteration_contract.json`](pins/opt081_iteration_contract.json);
  [`fixtures/opt081_kernel_parity_policy.json`](fixtures/opt081_kernel_parity_policy.json);
  [`cuda/kernel_parity.cuh`](cuda/kernel_parity.cuh);
  [`tools/kernel_parity.py`](tools/kernel_parity.py);
  [`tools/opt081_kernel_parity_policy.py`](tools/opt081_kernel_parity_policy.py);
  [`tests/test_opt081_kernel_parity_policy.py`](tests/test_opt081_kernel_parity_policy.py);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`evidence/optimization/opt081-kernel-parity-policy/REPORT.md`](evidence/optimization/opt081-kernel-parity-policy/REPORT.md).
  Proof is versioned kernel-admission policy, not a GPU speedup or model-quality
  gate. No tok/s claim (`claims_throughput=false`).
- Marked OPT-081 `done`; delivery is limited to the verified task scope plus
  this ledger/audit bookkeeping. `plan.md` is unchanged. OPT-016 and OPT-056 stay
  `blocked`. Next eligible pending by dependency order: **OPT-082**.

### 2026-09-11T21:18:00Z — OPT-082 CUDA kernel-parity suite delivered

- Ported a bounded ds4-style GPU kernel-parity suite on RTX 5090 via
  `qw38-cuda:13.0.2`. Native target
  `build/qw38-cuda-opt082-kernel-parity-test` covers Q4_K MMV/MMQ, Q8_0 mixer
  layouts, Q6_K vocab, fused gate/up and down projection, staging
  producer/consumer, and same-math equivalence cases against CPU dequant.
  Association wrappers in `quant_mmv_test.cu`, `prompt_mmq_test.cu`, and
  `ffn_tile_ab_test.cu` delegate to `cuda/kernel_parity.cuh` (no third
  `kAbsScale` copy). Catalog: q4=52, q8-q6=20, parity=105 (102 passed, 3
  documented fails with correct selectors and no nonfinite: fused SwiGLU vs
  independent MMV+host SiLU same_math; Q8 r1_w4/r2_w2 M17 K2048 association).
  No production pin or selector change. Coupled IDs: none.
- Acceptance: 8 pytest cases, feedback q4/q8-q6, acceptance parity phase, and
  manual verification checklist in [`tasks/OPT-082.md`](tasks/OPT-082.md).
- Acceptance evidence: [`tasks/OPT-082.md`](tasks/OPT-082.md);
  [`pins/opt082_iteration_contract.json`](pins/opt082_iteration_contract.json);
  [`fixtures/opt082_kernel_parity.json`](fixtures/opt082_kernel_parity.json);
  [`cuda/opt082_kernel_parity_test.cu`](cuda/opt082_kernel_parity_test.cu);
  [`tools/opt082_kernel_parity.py`](tools/opt082_kernel_parity.py);
  [`tests/test_opt082_kernel_parity.py`](tests/test_opt082_kernel_parity.py);
  [`Makefile`](Makefile);
  [`cuda/quant_mmv_test.cu`](cuda/quant_mmv_test.cu);
  [`cuda/prompt_mmq_test.cu`](cuda/prompt_mmq_test.cu);
  [`cuda/ffn_tile_ab_test.cu`](cuda/ffn_tile_ab_test.cu);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`evidence/optimization/opt082-kernel-parity/REPORT.md`](evidence/optimization/opt082-kernel-parity/REPORT.md).
  Proof is quantized-operation correctness, not a throughput or model-quality
  gate. No tok/s claim (`claims_throughput=false`).
...
### 2026-09-11T22:04:10Z — OPT-085 Q4 re-evaluation delivered

- Re-evaluated packed vs `integer_q8_paired` vs `late_w4` under OPT-082 kernel
  parity and OPT-084 quality freeze. **Packed retained**
  ...
  quality. Coupled IDs: none.
- Acceptance: 15 pytest cases, feedback parity/q4, acceptance quality/q4, and
  verification checklist in [`tasks/OPT-085.md`](tasks/OPT-085.md).
- Acceptance evidence: [`tasks/OPT-085.md`](tasks/OPT-085.md);
  [`pins/opt085_q4_reevaluation_contract.json`](pins/opt085_q4_reevaluation_contract.json);
  [`pins/opt085_iteration_contract.json`](pins/opt085_iteration_contract.json);
  [`fixtures/opt085_q4_reevaluation.json`](fixtures/opt085_q4_reevaluation.json);
  [`tools/opt085_q4_reevaluation.py`](tools/opt085_q4_reevaluation.py);
  [`tests/test_opt085_q4_reevaluation.py`](tests/test_opt085_q4_reevaluation.py);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`Makefile`](Makefile);
  [`evidence/optimization/opt085-q4-reevaluation/REPORT.md`](evidence/optimization/opt085-q4-reevaluation/REPORT.md).
  No tok/s claim (`claims_throughput=false`). Tok/s delta versus packed
  baseline: **0**.
- Marked OPT-085 `done`; delivery is limited to the verified task scope plus
  this ledger/audit bookkeeping. `plan.md` is unchanged. OPT-016 and OPT-056 stay
  `blocked`. Next eligible pending by dependency order: **OPT-086**.

### 2026-09-11T22:22:00Z — OPT-086 Q8/MMQ re-evaluation delivered

- Re-evaluated installed Q8 `r2_w2` and MMQ `fma_async_x` under OPT-082 kernel
  parity and OPT-084 quality freeze. **Q8 reverted** to `r1_w4`
  ...
  **MMQ kept** `fma_async_x` (`production_kept=true`; `fma_async` rejected on
  performance). `opt074_coverage_unadmitted` is not a keep blocker. Coupled IDs:
  none.
- Acceptance: 32 pytest cases, feedback q8/mmq, acceptance q8/mmq, and
  verification checklist in [`tasks/OPT-086.md`](tasks/OPT-086.md).
- Acceptance evidence: [`tasks/OPT-086.md`](tasks/OPT-086.md);
  [`pins/opt086_q8_mmq_reevaluation_contract.json`](pins/opt086_q8_mmq_reevaluation_contract.json);
  [`pins/opt086_iteration_contract.json`](pins/opt086_iteration_contract.json);
  [`fixtures/opt086_q8_mmq_reevaluation.json`](fixtures/opt086_q8_mmq_reevaluation.json);
  [`tools/opt086_q8_mmq_reevaluation.py`](tools/opt086_q8_mmq_reevaluation.py);
  [`tests/test_opt086_q8_mmq_reevaluation.py`](tests/test_opt086_q8_mmq_reevaluation.py);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`Makefile`](Makefile); [`cuda/q8_decode_path.cuh`](cuda/q8_decode_path.cuh);
  [`evidence/optimization/opt086-q8-mmq-reevaluation/REPORT.md`](evidence/optimization/opt086-q8-mmq-reevaluation/REPORT.md).
  ...
  shipping).
- Marked OPT-086 `done`; delivery is limited to the verified task scope plus
  this ledger/audit bookkeeping. `plan.md` is unchanged. OPT-016 and OPT-056 stay
  `blocked`. Next eligible pending by dependency order: **OPT-087**.

### 2026-09-11T22:32:44Z — OPT-087 historical leftover reevaluation delivered

- Reviewed OPT-072 and OPT-075–079/085/086 evidence for remaining
  numerical-policy-blocked candidates. **No additional reopen**
  (`no_additional_reopen=true`; `reopened_candidate=null`). Twenty candidates
  dispositioned; OPT-085/086 ownership and OPT-072 `no_repeat` performance
  losers left closed. `opt074_coverage_unadmitted` is not a blocker. Coupled IDs:
  none.
- Acceptance: 10 pytest cases, feedback inventory, acceptance review, and
  verification checklist in [`tasks/OPT-087.md`](tasks/OPT-087.md).
- Acceptance evidence: [`tasks/OPT-087.md`](tasks/OPT-087.md);
  [`pins/opt087_historical_reevaluation_contract.json`](pins/opt087_historical_reevaluation_contract.json);
  [`pins/opt087_iteration_contract.json`](pins/opt087_iteration_contract.json);
  [`fixtures/opt087_historical_reevaluation.json`](fixtures/opt087_historical_reevaluation.json);
  [`tools/opt087_historical_reevaluation.py`](tools/opt087_historical_reevaluation.py);
  [`tests/test_opt087_historical_reevaluation.py`](tests/test_opt087_historical_reevaluation.py);
  [`tools/run_optimization_task.py`](tools/run_optimization_task.py);
  [`Makefile`](Makefile);
  [`evidence/optimization/opt087-historical-reevaluation/REPORT.md`](evidence/optimization/opt087-historical-reevaluation/REPORT.md).
...
### 2026-09-12T07:50:00Z — OPT-091 successor quality gate delivered

- Froze `opt091_late_w4_v1` with separate `absolute_quality_status`,
  `strict_model_quality_pass`, `successor_model_quality_pass`, and
  `regression_release_quality_pass` fields. OPT-089 already admitted `late_w4`
  under strict `opt089_strict` quality; `concession_used=false`, no pin change,
  timed phases `not_applicable`. `claims_throughput=false`.
- Acceptance evidence: [`tasks/OPT-091.md`](tasks/OPT-091.md);
  [`evidence/optimization/opt091-quality-tradeoff/REPORT.md`](evidence/optimization/opt091-quality-tradeoff/REPORT.md).
- Marked OPT-091 `done`. Next eligible pending by dependency order: **OPT-092**.

### 2026-09-12T08:30:00Z — OPT-092 grouped Q8 projections delivered

- Kept `grouped_r1_w4`: exact staged-byte/bitwise parity vs separate r1_w4;
  input-projection launches 240→64 (−176/token); complete rotating mixer paired
  CI +0.49 ms/token (0.31..0.67); D2048+32 engine 643.70→627.89 ms
  (49.71→50.96 tok/s, +1.25, 1.025×); D128/p95/P4096 guards pass;
  `opt089_strict` quality reused. Pin `kSelectedQ8DecodeGrouping=grouped_r1_w4`.
  `claims_throughput=true`.
...
### 2026-09-12T09:15:00Z — OPT-094 conditional GDN replication delivered

- `no_reopen`: OPT-090 `gdn_reopen_eligible=false`
  (`no_opt077_timing_capture_defect_repaired`). Prior OPT-077 tile32 CI was
  inconclusive, not a repaired timing defect. Retained shipping GDN decode
...
- Key evidence: [`fixtures/opt094_gdn_replication.json`](fixtures/opt094_gdn_replication.json);
...
### 2026-09-12T16:38:33Z — OPT-102 Q4 layout unpack delivered (reject)

- Added lossless Q4_K aligned metadata/code-plane layout and branchless
  scale/min unpack (`tools/opt102_q4_repack.py`, contracts, fixture, tests,
  `cuda-opt102-diagnostics`, `q4k_aligned_layout.cuh`, decode/MMQ/scheduler
  layout selectors). Kernel parity 16/16 bitwise; OPT-089 quality reuse under
  `opt089_strict`. OPT-093 factored association is not a candidate.
- Complete rotating FFN acceptance (3+10): late_w4 **9.842 ms** vs
  branchless **10.317 ms** vs aligned **10.172 ms**; aligned mean_diff
  **−0.330 ms**; CI95 **[−0.362, −0.298]**; `positive=false`. Keep gate
  ≥0.10 ms/token failed. D128 five-pair 574.69 vs 583.65 ms (guards fail);
  D2048 628.74 vs 636.65 ms (candidate slower); P4096 2990.63 vs 2994.56
  tok/s (not a keep).
- Production pins remain `kSelectedQ4DecodePath[] = "integer_q8_late"` and
  `kSelectedQ4DeviceLayout[] = "raw_gguf"`. `claims_throughput=false`.
  `evidence_complete=true`.
- Key evidence: [`fixtures/opt102_q4_repack.json`](fixtures/opt102_q4_repack.json);
  [`evidence/optimization/opt102-q4-layout-unpack/REPORT.md`](evidence/optimization/opt102-q4-layout-unpack/REPORT.md);
  [`evidence/optimization/opt102-q4-layout-unpack/REJECTION.md`](evidence/optimization/opt102-q4-layout-unpack/REJECTION.md).
- **tok/s delta vs OPT-098 P4096 baseline (3046.23 tok/s): 0** (rejection; no
  throughput claim).
...
### 2026-09-12T17:42:51Z — OPT-104 aligned Q6 layout delivered (reject)

- Added aligned SoA Q6_K device-layout tooling (`tools/opt104_q6_aligned.py`,
  contracts, fixture, tests, `cuda-opt104-diagnostics`, `q6k_aligned_layout.cuh`,
  layout selector hooks in Q6 decode/MMV/MMQ paths). Kernel parity 12/12
  bitwise; OPT-089 quality reuse under `opt089_strict`. No public GGUF rewrite;
  no extra persistent Q6 copy. Decode path pin stays `integer_q8_1`.
- Complete rotating Q6 acceptance (3+10, 16 attention outputs + logits):
  control **1.559 ms** vs candidate **1.566 ms**/token; mean_diff **−0.0072 ms**;
  CI95 **[−0.0156, 0.0012]**; `positive=false`. Keep gate ≥0.10 ms/token failed;
  D128/P4096 gates not run.
- Production pins remain `kSelectedQ6DeviceLayout[] = "raw_gguf"` and
  `kSelectedQ6DecodePath[] = "integer_q8_1"`. `claims_throughput=false`.
- Key evidence: [`fixtures/opt104_q6_aligned.json`](fixtures/opt104_q6_aligned.json);
  [`evidence/optimization/opt104-q6-aligned-layout/REPORT.md`](evidence/optimization/opt104-q6-aligned-layout/REPORT.md);
  [`evidence/optimization/opt104-q6-aligned-layout/REJECTION.md`](evidence/optimization/opt104-q6-aligned-layout/REJECTION.md).
- **tok/s delta vs OPT-098 P4096 baseline (3046.23 tok/s): 0** (rejection; no
  throughput claim).
...
### 2026-09-12T23:24:41Z — OPT-109 persistent GDN session layout delivered (reject)

- Added resident col-major FP32 GDN session layout admission path
  (`tools/opt109_persistent_gdn_state.py`, contracts, fixture, tests,
  `cuda-opt109-diagnostics`, `opt109_persistent_gdn_state_test.cu`). Control is
  production sequential row-major (`kSelectedGdnDecodePath[] = "sequential"`).
  Session design: col-major device state for the session lifetime, zero timed
  per-layer relayout, canonical row-major checkpoint round-trip, CUDA graph AB/BA
  variants.
- Pilot recurrence-only (3+10): sequential **0.02592 ms** vs persistent
  **0.01102 ms**; mean_diff **+0.01489 ms**; 95% CI low **+0.01153**;
  `positive=true`; `timed_relayout=0`.
- Complete 48-layer GDN enclosing (3+10, capture
  `8b954514af28526225acbdc344b48dcc98485daa454a1835f8f7c43f021433e6`):
  sequential **13.190 ms** vs persistent **13.993 ms**; mean_diff **−0.803
  ms**; 95% CI **[−1.053, −0.553]**; `positive=false`;
  `saving_ge_0_10_ms=false`; `timed_relayout_launches=0`;
  `decode_conversions=0`. Stop rule: enclosing wall lost despite kernel-only
  win. D128/D2048 engine pairs and P4096 skipped (`complete_gdn_lost`).
- **Reject.** Production unchanged: sequential row-major GDN decode retained.
  `claims_throughput=false`. OPT-077/094/101 rejection evidence retained.
- Key evidence: [`fixtures/opt109_persistent_gdn_state.json`](fixtures/opt109_persistent_gdn_state.json);
...
- **tok/s delta vs OPT-114 baseline (fresh sitting): 0** (rejection; production
  unchanged).
- Marked OPT-109 `done`. Coupled IDs: none. First eligible pending task:
  **OPT-110**.

### 2026-09-12T23:59:00Z — OPT-110 pinned llama Q4 adapter delivered (quality_blocked reject)

- Added source-faithful Quartz adapter of pinned llama.cpp GENERIC nwarps=4
  `mul_mat_vec_q<Q4_K, ncols_dst=1>` plus fused SWIGLU (`tools/opt110_llama_q4_adapter.py`,
  contracts, fixture, tests, `cuda-opt110-diagnostics`, `opt110_llama_q4_adapter.cuh`,
  provenance manifest). Control is production `integer_q8_late` / `raw_gguf` / 4
  warps with FP32-scale `Q8Block` staging; candidate uses native `block_q8_1`
  staging and MMVQ. Diagnostic engine hooks only; production pin unchanged.
- Matched primitive (3+10, identical BF16 + Q4_K at production M/N/K):
  combined staging+dot saving **+0.050 ms/layer**; `primitive_win=true`.
- Complete rotating 64-layer FFN (3+10): control **9.814 ms** vs candidate
  **9.097 ms**; saving **+0.717 ms/token**; 95% CI **[0.678, 0.756]**;
  `ffn_keep=true`. D128 **55.01 → 58.27 tok/s**; D2048 **53.31 → 56.67
  tok/s**; P4096 ratio **0.99985**.
- **quality_blocked reject.** Performance keep bar met; candidate NLL **not
  measured** (`candidate_nll_not_measured`). Production unchanged:
  `kSelectedQ4DecodePath[] = "integer_q8_late"`. `claims_throughput=false`.
- Key evidence: [`fixtures/opt110_llama_q4_adapter.json`](fixtures/opt110_llama_q4_adapter.json);
...
- **tok/s delta vs OPT-114 baseline (fresh sitting): 0** (quality_blocked
  reject; production unchanged).
- Marked OPT-110 `done`. Coupled IDs: none. First eligible pending task:
  **OPT-111**.

### 2026-09-13T05:35:00Z — OPT-110 pinned llama Q4 adapter revised to keep

- Reopened the interim `quality_blocked` delivery after measuring candidate NLL
  on the OPT-058 quality harness (104 s GPU sitting). Held-out PPL ratio
  **1.00037**, wikitext **0.99847**, recurrence incremental vs control
  **−0.00611** (|Δ| ≤ 0.02). Verdict revised to **`keep`**.
- Flipped production to `kSelectedQ4DecodePath[] = "llama_q4k_mmvq"` /
  `raw_gguf` / 4 warps. Prior `integer_q8_late` control evidence retained in
  fixture replay rows.
- **tok/s delta vs OPT-114 baseline (fresh sitting): D2048 +8.283**, D128
  **+4.809**, P4096 **+35.454** (primary ledger field uses D2048).
- Key evidence: [`fixtures/opt110_llama_q4_adapter.json`](fixtures/opt110_llama_q4_adapter.json);
  [`evidence/optimization/opt110-llama-q4-adapter/REPORT.md`](evidence/optimization/opt110-llama-q4-adapter/REPORT.md).
  Supersedes the 2026-09-12T23:59:00Z quality_blocked entry.
- Marked OPT-110 `done`. Coupled IDs: none. First eligible pending task:
  **OPT-111**.

### 2026-09-13T06:36:00Z — OPT-111 llama F16 MMA prompt-attention delivered (keep)

- Added source-backed Quartz adapter of pinned llama.cpp Ampere `fattn-mma-f16`
  (DKQ=DV=256, ncols=32) over shipping OPT-079 `kv_once`
  (`tools/opt111_llama_prompt_attention.py`, contracts, fixture, tests,
  `cuda-opt111-diagnostics`, `opt111_llama_prompt_attention.cuh`, provenance
  manifest). Base candidate `opt111_base` is convert-once plus llama
  decreasing-granularity `cp.async` KV load; XOR screened after measured
  bank-conflict hypothesis but not selected.
- Matched primitive (3+10, prep+combine+conversion included): won on rows
  32/128/512/2048/4096; row 1 tiled parity-only. Complete 16-layer P4096:
  saving **32.436 ms**; 95% CI **[32.407, 32.464]**; `keep_bar_pass=true`.
  P4096 engine AB/BA 5 graph pairs: **2998.38 → 3046.73 tok/s**; `faster=true`;
  `within_2pct=true`. D128/D2048 within OPT-114 2% bound.
- Quality measured via OPT-058 (`candidate_nll_measured=true`); held_out and
  wikitext ppl_ratio=1.0; parity max_abs=0. Verdict **`keep`**.
- Flipped production to `kSelectedAttentionPipelinePath[] = "opt111_base"` in
  `cuda/fattn_mma_f16.cuh`.
- **tok/s delta vs OPT-114 baseline: P4096 +65.6** (3046.73 vs 2981.09),
  **D128 +4.959**, **D2048 +8.416**.
- Key evidence: [`fixtures/opt111_llama_prompt_attention.json`](fixtures/opt111_llama_prompt_attention.json);
...
- Marked OPT-111 `done`. Coupled IDs: none. First eligible pending task:
  **OPT-113** (OPT-112 deferred).

### 2026-09-13T06:52:00Z — OPT-112 norm→typed Q8 staging delivered (defer)

- Added screen-first host admission path for decode normalization → typed Q8
  staging (`tools/opt112_norm_q8_staging.py`, contracts, fixture, tests,
  `cuda-opt112-diagnostics` host-only). Sources OPT-099 D128/D2048 family
  aggregates (OPT-090 peer). Consumer inventory covers GDN/attention Q8_1 groups,
  FFN `block_q8_1` vs FP32-scale `Q8Block`, and BF16-retained `logits_norm`.
- Fresh component screen: OPT-099 unmatched `ffn_norm` D2048 window 26.288 ms
  is an upper-bound clue (0.8215 ms/token), not a removable budget.
  `activation_quant` is 0 (restage inside projection intervals). Min potentially
  removable **0.2496 ms/token** (`residual_mixer`) is below the **0.50
  ms/token** trigger at both prefixes. Verdict **`deferred_below_trigger`**;
  fusion candidates `norm_to_typed_q8_rounded` and
  `residual_norm_to_typed_q8_rounded` were **not** implemented.
- Production unchanged: no OPT-112 references under `cuda/`; shipping path
  `current_bf16_q8_staging` retained. `claims_throughput=false`.
  `claims_performance_improvement=false`. Quality/OPT-058 not required on defer.
- Key evidence: [`fixtures/opt112_norm_q8_staging.json`](fixtures/opt112_norm_q8_staging.json);
...
### 2026-09-13T14:27:54Z — OPT-117 decode-segment graphs delivered (reject)

- Repaired `decode_segments8` capture on authenticated post113 (8 segment graphs,
  ~8.3 ms create). Root-caused OPT-114 generic capture failure: OPT-110 adapter
  hooks plus committed-vs-workspace candidate aliasing. Same-math, positions,
  pointer swaps, cancellation, quality, and state/memory pass.
- Full-engine 3+10 AB/BA on RTX 5090: D128 57.41 vs 56.23 tok/s (geo 0.979),
  D2048 55.66 vs 54.57 (geo 0.980); both throughput gates fail. Per-token
  recapture (257 launch-param updates / 256 decode tokens) dominates OPT-115
  idle-leaf estimate. **Measured reject: retain `ffn_only`.** No production pin
  flip; **tok/s delta 0** vs sitting baseline.
- Key evidence: [`fixtures/opt117_decode_segment_graphs.json`](fixtures/opt117_decode_segment_graphs.json);
...
- OPT-117 marked `done`. Coupled IDs: none. First eligible pending task: **OPT-118**.

### OPT-118 delivery (2026-09-13T15:06:00Z)

- Lazy host logits/hidden with device greedy argmax plus decode D2H overlap on
  authenticated post113 `ffn_only` parent. Inventory: eager decode D2H
  1 013 760 B/token → lazy 4 B/token; GDN carry D2D not on production path.
- Full-engine 3+10 AB/BA on RTX 5090: D128 parent 54.772 vs candidate 54.945
  tok/s (geo 1.003, CI lower 1.003, p95 ratio 0.997); D2048 47.432 vs 47.547
  (geo 1.002). Same-math, API, quality (held-out NLL 1.7875990840085783), and
  state/memory pass. **Measured keep:** `kSelectedLazyOutputMaterialization` and
  `kSelectedOutputCommitOverlap` pinned true. **D128 tok/s delta +0.172** vs
  post113 parent.
- Key evidence: [`fixtures/opt118_transfer_residency.json`](fixtures/opt118_transfer_residency.json);
  [`evidence/optimization/opt118-transfer-residency/REPORT.md`](evidence/optimization/opt118-transfer-residency/REPORT.md).
- OPT-118 marked `done`. Coupled IDs: none. First eligible pending task: **OPT-119**.

### OPT-119 delivery (2026-09-13T15:32:42Z)

- Mixer RMSNorm→MMQ Q8_0 and FFN residual+norm→MMQ Q4K Q8 fusion on authenticated
  post-OPT-118 `ffn_only` parent. Inventory: 167772160 B BF16 activation reread
  removed at prefix 128 (83886080 B per slice).
- Full-engine 3+10 AB/BA on RTX 5090: P4096 parent 2958.823 vs candidate
  2976.482 tok/s (geo 1.006, CI lower 1.005); D128 54.937 vs 54.935 (geo
  1.000); D2048 47.531 vs 47.545 (geo 1.000). Same-math, API, tails, quality
  (held-out NLL 1.7875990840085783), and state/memory pass. **Measured keep:**
  `kSelectedMixerNormQ8Fusion` and `kSelectedFfnNormQ8Fusion` pinned true.
  **P4096 tok/s delta +17.659** vs post-OPT-118 parent.
- Key evidence: [`fixtures/opt119_activation_pipeline.json`](fixtures/opt119_activation_pipeline.json);
  [`evidence/optimization/opt119-activation-pipeline/REPORT.md`](evidence/optimization/opt119-activation-pipeline/REPORT.md).
- OPT-119 marked `done`. Coupled IDs: none. First eligible pending task: **OPT-120**.

### OPT-120 delivery (2026-09-13T18:31:00Z)

- Integer Q8 group-32 packed KV (`q8q8`) evaluated on authenticated post113
  `ffn_only` parent. Packed 128K cache 4.25 GiB vs dense 8.00 GiB; attention
  unpacks into registers with no dense shadow. OPT-058 held-out PPL ratio
  1.000634; OPT-116 long-cache fail (8192 PPL 1.011, 32768 1.039 vs max
  1.01). Target decode throughput gates fail (D8192 geo 0.624, D32768 0.316,
  D131040 0.215). **Measured reject:** `quality_blocked`; production pin
  `kSelectedPackedKvFormat = kDenseBf16`. **Sitting tok/s delta 0** (baseline
  unchanged).
- Key evidence: [`fixtures/opt120_packed_kv.json`](fixtures/opt120_packed_kv.json);
  [`evidence/optimization/opt120-packed-kv/REPORT.md`](evidence/optimization/opt120-packed-kv/REPORT.md).
- OPT-120 marked `done`. Coupled IDs: none. Next pending: **OPT-122** (OPT-121
  still `in_progress`).

### OPT-121 delivery (2026-09-13T19:27:00Z)

- Selective Q8→packed Q4_K (`q8_to_q4k`) on 192 GDN/mixer/attention projections
  vs post-OPT-119 `ffn_only` parent. 3.36 GB traffic saved; conversion 15.8 s;
  real packed MMV/MMQ consumers; GGUF unmodified; no dense shadow. FP4 study
  stopped (`fp4_capability_absent`). OPT-058 held-out PPL 1.00057 but GDN
  recurrence ΔNLL +3.92/+3.46 (max 0.02). OPT-116 long-cache fail. Target
  decode throughput gates fail (D128 geo 0.870, D2048 0.909). **Measured
  reject:** `quality_blocked`; production pin `kSelectedWeightRequantConfig[] =
  "none"`. **Sitting tok/s delta 0** (baseline unchanged).
- Key evidence: [`fixtures/opt121_weight_traffic.json`](fixtures/opt121_weight_traffic.json);
  [`evidence/optimization/opt121-weight-traffic/REPORT.md`](evidence/optimization/opt121-weight-traffic/REPORT.md).
- OPT-121 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-123** (OPT-122 still `in_progress`).

### OPT-122 delivery (2026-09-13T19:50:00Z)

- BF16 and block-scaled Q8 recurrent-state encodings evaluated on authenticated
  post113_selected `ffn_only` parent after OPT-118 kept lazy/overlap. Inventory:
  gdn_core 2.008 ms; DRAM FP32 317718528 B; decode commits by pointer swap;
  prompt carry D2D unused at 4096 chunk pin. Reference: BF16 RMS 0.00753; Q8
  RMS 0.0176. Roofline critical-path upper bound **0.0** ms on both candidates
  (compute-bound enclosing sink; recurrence-only BF16 leaf +0.297 ms not used
  to admit). Complete-request A/B not required. **Measured disposition:**
  `no_material_opportunity`; production pin `kSelectedGdnStateFormat = kFp32`.
  **Sitting tok/s delta 0** (baseline unchanged).
- Key evidence: [`fixtures/opt122_gdn_state_precision.json`](fixtures/opt122_gdn_state_precision.json);
...
### OPT-125 delivery (2026-09-13T22:12:00Z)

- Diagnostics-only decode timing, GPU activity, and traffic-evidence
  reconciliation on the OPT-123 combined stack (`combined_opt118_opt119`)
  versus authenticated post113 and pinned llama. Corrected request/decode
  metric boundaries; fresh A/A matched baseline P4096/D128/D2048 combined
  decode-only vs llama **0.966 / 0.801 / 0.692×** (D2048 published **0.620×**
  does not survive matched decode-only boundaries). CUDA event activity trace
  on 12-token early/middle/late windows: proven device-inactive **0 ms**;
  ~10.55 ms/token leaf-gap relabeled unobserved, not proven true inactive.
  D128 busy/compulsory bound **unsupported** (8.30 ms active vs 10.18 ms
  optimistic minimum). Long-context fresh D8192/D32768/D131040/OPT-016 2K OOM
  on non-exclusive sitting; historical stored-field corrections retained.
  OPT-126/127/129 **proceed**; OPT-128/130/131 **insufficient_evidence**.
  **Measured disposition:** diagnostics baseline established; production pins
  unchanged. **`claims_throughput=false`**. **Sitting tok/s delta 0**
  (baseline unchanged).
- Key evidence: [`fixtures/opt125_decode_accounting.json`](fixtures/opt125_decode_accounting.json);
...
- Foundation/correctness prerequisite for stable decode graph inputs across
  token commits. Session-owned device `DecodeLaunchState` (56 bytes) uploads
  dynamic scalars in stream order; GDN uses `stable_pingpong_committed_slot`
  (not two parity graph variants). Segment graphs expanded to 16 (8×2
  topologies); recapture only on ping-pong base or KV identity change, not
  ordinary frontier or GDN slot flips. Same-math `exact=true` across positions
  0/127/1023/1024/2047 and near capacity; cancel/retry/failure candidate
  isolation; checkpoint restore with generation bump and stale-descriptor
  rejection. **Measured disposition:** `prerequisite_verified`;
  `production_kept=false`; `claims_throughput=false`. Shipping selector
  unchanged (`ffn_only`). OPT-127 owns replay admission. **Sitting tok/s delta
  0** (no production speed keep).
- Key evidence: [`fixtures/opt126_stable_graph_inputs.json`](fixtures/opt126_stable_graph_inputs.json);
  [`evidence/optimization/opt126-stable-graph-inputs/INVENTORY.md`](evidence/optimization/opt126-stable-graph-inputs/INVENTORY.md);
  [`evidence/optimization/opt126-stable-graph-inputs/REPORT.md`](evidence/optimization/opt126-stable-graph-inputs/REPORT.md).
- OPT-126 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-127**.

### OPT-127 delivery (2026-09-13T23:58:00Z)
...
- Recapture-free eight-layer segment replay on OPT-126 stable inputs
  ...
  Steady-state tokens within one topology show zero capture/instantiate/upload/
  destroy/recapture deltas; crossover 1024 selects prebound topology 1.
  Same-math `exact=true`; cancellation atomic commit preserved; OPT-058
  quality (held-out PPL ratio 1.0), state/memory, checkpoint, and 128K fit
  pass. Full-engine 3+10 AB/BA on RTX 5090 vs post124 `ffn_only` parent:
  D128 request 54.21 → 58.06 tok/s (**+3.85**, 1.071×); D2048 request
  41.66 → 44.28 tok/s (**+2.62**, 1.063×); decode-only D128 55.21 → 59.26;
  decode-only D2048 46.69 → 50.00. P4096 request geo 0.999 (non-target guard).
  **Measured keep:** production pin flipped `kSelectedExecutionGraphPath[] =
  "decode_segments8"`. No weight-byte reduction claimed.
- Key evidence: [`fixtures/opt127_recapture_free_replay.json`](fixtures/opt127_recapture_free_replay.json);
  [`evidence/optimization/opt127-recapture-free-replay/REPORT.md`](evidence/optimization/opt127-recapture-free-replay/REPORT.md).
- OPT-127 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-129** (OPT-128 still `in_progress`).

### OPT-128 delivery (2026-09-14T00:16:00Z)

- Host submission and synchronization stall study on OPT-127 kept
  `decode_segments8`. Reprofiled the Session sample/eval/output loop (greedy
  sample + eval, with and without server cancellation poller). Ranked blocking
  copies, stream/device syncs, hot-path allocation, and launch-param updates.
  Two gated candidates measured and not frozen: (1) poll host cancel flag
  without per-segment `cudaDeviceSynchronize`, (2) defer `cudaEventSynchronize`
  until after scatter/commit launch. Poll wall save **0.063 ms/token**; defer
  wall save **-0.049 ms/token** (shifted wait into scatter
  `cudaDeviceSynchronize`; not a removed wait). Combined attributable upper
  bound **0.065 ms/token** (~0.4% of server-poll wall); freeze threshold
  **0.20 ms/token**. Lazy greedy D2H remains **4 bytes**; lifetime,
  cancellation, and logits-consumer guards pass. **Measured
  `no_material_opportunity`:** production selector unchanged `decode_segments8`;
  `kSelectedPollWithoutDeviceSync=false`,
  `kSelectedDeferElapsedEventSync=false`. **Sitting tok/s delta 0**
  (baseline unchanged `decode_segments8`).
- Key evidence: [`fixtures/opt128_host_stalls.json`](fixtures/opt128_host_stalls.json);
  [`evidence/optimization/opt128-host-stalls/REPORT.md`](evidence/optimization/opt128-host-stalls/REPORT.md).
- OPT-128 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-129**.

### OPT-129 delivery (2026-09-14T00:38:00Z)

- Matched Quartz vs llama decode-attention component replay on identical
  inputs (layers 3/7/63 × prefixes 128/1023/1024/2048/8192/32768). Native
  Quartz BF16 KV vs llama f16/f16 with common-input matched-layout replay and
  adapter cost reported separately. Actual kernel identities recorded (not
  flash-attn auto config alone). Attention is **material** (D128 3.2%, D2048
  7.5% of OPT-125 request; D32768 branch 49 ms/token in component replay).
  D2048 prefix-mean enclosing: quartz 0.113 vs matched llama 0.029 ms/layer;
  shipping Quartz does not match OPT-108 control. F16 vec at 8192/32768 flagged
  `matched_result: false` (llama source-selects MMA). Two ranked OPT-130
  transfers: `occupancy_partition_or_gqa_kv_reuse` (matched BF16; D2048
  removable ~1.34 ms/token) and `llama_mma_decode_consumer` (unmatched; BF16
  MMA consumer required). **OPT-130 disposition `proceed`.** Diagnostics only:
  `hybrid_crossover@1024` unchanged; `claims_throughput=false`,
  `claims_performance_improvement=false`. **Sitting tok/s delta 0** (baseline
  unchanged).
- Key evidence: [`fixtures/opt129_matched_attention.json`](fixtures/opt129_matched_attention.json);
  [`evidence/optimization/opt129-matched-attention/REPORT.md`](evidence/optimization/opt129-matched-attention/REPORT.md).
- OPT-129 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-130**.

### OPT-130 delivery (2026-09-14T01:10:00Z)

- Primary OPT-129 transfer `occupancy_partition_or_gqa_kv_reuse` frozen as
  `hybrid_crossover@1024_vec128_open_nparts8`: occupancy-snapped legal
  `n_parts=8` (D2048 raw ~9) and `vec128_online` past verified_max 4096.
  Rank-2 `llama_mma_decode_consumer` not launched (unmatched BF16 MMA;
  shadow F16 cache forbidden). OPT-058 quality measured on both arms (held-out
  and wikitext PPL ratio 1.0); state/memory/cancellation pass. Full-engine
  3+10 AB/BA on RTX 5090 vs post124 `decode_segments8` parent: D128 request
  57.969 → 57.968 tok/s (geo 1.000, CI lower 0.99975 **fail**); D2048 request
  44.150 → 45.006 tok/s (geo 1.019, CI lower 1.019 **pass**); P4096 request
  geo 0.999 (non-target). **Measured reject:** `d128_throughput_gate`,
  `measured_loss_or_no_request_win`; production pins unchanged
  `hybrid_crossover@1024` / `n_parts=16` / `verified_max=4096`.
  **Sitting tok/s delta 0** (baseline unchanged).
- Key evidence: [`fixtures/opt130_dense_attention.json`](fixtures/opt130_dense_attention.json);
  [`evidence/optimization/opt130-dense-attention/REPORT.md`](evidence/optimization/opt130-dense-attention/REPORT.md).
- OPT-130 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-131**.

### OPT-131 delivery (2026-09-14T01:27:00Z)

- Residual decode launch-chain fusion study on OPT-127 kept `decode_segments8`
  after OPT-128 `no_material_opportunity` and OPT-130 `reject`. Profiled
  remaining adjacent producer/consumer chains in `cuda/scheduler_primitives.cu`,
  `cuda/gdn_step.cu`, and `cuda/full_scheduler.cu` on the graph parent versus
  eager. OPT-119 mixer/FFN norm→Q8 retained; GDN chains stay unfrozen per
  OPT-109 isolated win / enclosing loss. Top remaining legal chain
  `mixer_residual_add_to_ffn_norm`: traffic upper bound **0.026 ms/token**
  versus freeze threshold **0.20 ms/token** (2% request materiality
  **0.327 ms/token**). `decode_segments8` already removed **3.17 ms/token** of
  eager launch gap. Lifetime, cancellation, equivalence, and OPT-125
  state/memory guards pass. **Measured `no_material_opportunity`:** no
  production edit; shipping decode-chain fusion `none`. **Sitting tok/s delta
  0** (baseline unchanged `decode_segments8`).
- Key evidence: [`fixtures/opt131_decode_chain.json`](fixtures/opt131_decode_chain.json);
  [`evidence/optimization/opt131-decode-chain/REPORT.md`](evidence/optimization/opt131-decode-chain/REPORT.md).
- OPT-131 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-132** (already `in_progress`).

### OPT-132 delivery (2026-09-14T02:06:00Z)

- Combined decode-stack admission on authenticated post124 control (OPT-118+119
  `ffn_only`) plus OPT-127 `decode_segments8` only. Rejected OPT-130 occupancy
  selector (`hybrid_crossover@1024`, `n_parts=16`), OPT-128 host pins, and
  OPT-131 fusion remain excluded. Interaction matrix: control, combination,
  combination minus OPT-126+127 unit; graph × attention not applicable (OPT-130
  rejected). OPT-058 quality measured (`--quality`); held-out and wikitext PPL
  ratio **1.0**. Paired 3+10 AB/BA complete-request vs post124 (OPT-125
  boundaries): D128 **54.25→58.07 tok/s** (**+3.82**, **1.070×**, CI lower
  1.070); D2048 **41.71→44.27 tok/s** (**+2.57**, **1.062×**, CI lower 1.061);
  aggregate CI lower **1.033 > 1.0** (geo 1.043, n=30). Matched llama
  decode-only headroom (pinned `cc83d7b4824f73cfdda4dfbb47ee39804f71b328`): D128
  **0.862×** (59.26 vs 68.77 tok/s); D2048 **0.744×** (50.00 vs 67.24 tok/s).
  OPT-124 D2048 **0.620×** mixed complete-request/decode-only boundary does not
  survive corrected OPT-125 metrics. **Measured `keep`:** shipping selector
  `decode_segments8` unchanged (already OPT-127 keep).
- Key evidence: [`fixtures/opt132_combined_decode.json`](fixtures/opt132_combined_decode.json);
...
- Exclusive GPU sitting after stopping zanzara-archive GPU services. Fresh
  ...
  (`nsight_systems_absent` cleared by OPT-133 nsys upgrade; see 2026-09-14T12:50:00Z).
...
### OPT-133 evidence amendment (2026-09-14T12:50:00Z)

- Upgraded pinned image to **`cuda-nsight-systems-13-0`** (NVIDIA CUDA repo;
  **nsys 2025.3.2** at `/usr/local/cuda/bin/nsys`). Removed Ubuntu multiverse
  nsys 2022.4.2 and stale `.qdrep` traces.
- Re-ran all OPT-133 phases on `build/optimization-runs/opt133-nsys2025`. Six
  `.nsys-rep` captures + baselines; mean nsys wrapper overhead **0.18 ms**;
  `hardware_gpu_trace=true` via `cuda_gpu_trace`/`cuda_api_sum`.
- OPT-125 unobserved **~126 ms**/12-token window **fully explained** by Nsight
  hardware idle (fraction **1.0**); unresolved **0 ms**. Dominant API time is
  `cudaEventSynchronize` from CUDA-event instrumentation (~193–244 ms/window);
  actual GPU kernel union ~**8 ms**/window. Removable decode headroom still
  **not proven**.
- Amended: [`docker/cuda.Dockerfile`](docker/cuda.Dockerfile);
  ...
  [`evidence/optimization/opt133-decode-nsys-trace/REPORT.md`](evidence/optimization/opt133-decode-nsys-trace/REPORT.md);
  [`tasks/OPT-133.md`](tasks/OPT-133.md); cross-amendments in
  [`tasks/OPT-125.md`](tasks/OPT-125.md),
  [`tasks/OPT-132.md`](tasks/OPT-132.md), and OPT-125/132 evidence reports.

### OPT-125/132 evidence amendment (2026-09-14T12:50:00Z)

- OPT-133 Nsight reconciliation amends interpretation of OPT-125/132 CUDA-event
  **unobserved** leaf gaps (hardware idle on Nsight, not missing kernels). OPT-125
...
### OPT-134 delivery (2026-09-14T13:38:22Z)

- Replaced OPT-020-first performance steering in both ledger runner skills with
  coverage-before-ranking evidence discipline. Added identical
  `performance-evidence-checklist.md` and `performance-evidence-review-cases.md`
  (eight adversarial cases) to each skill tree; linked from admission, planning,
  documentation, verification and completion. Documentation remains unverified
  draft before verification; separate candidate measured delta, shipping delta,
  quality result and evidence completeness. OPT-136 `coverage.json` required when
  available; absence labeled `unavailable`, not an executable-check pass. Codex
  model routing and Cursor slugs unchanged.
- Verification **PASS** (2026-09-14T13:37:00Z): `git diff --check` and cross-tree
  `diff -u` on checklist/review-cases empty; all eight adversarial cases enforced;
  contradictory steering removed; scope limited to skill files and dossier.
- Throughput delta: **N/A** (runner instructions only; no CUDA, NLL, or throughput
  measurements).
- Key evidence: [`tasks/OPT-134.md`](tasks/OPT-134.md);
  [`.agents/skills/run-ledger-task-codex/references/performance-evidence-checklist.md`](.agents/skills/run-ledger-task-codex/references/performance-evidence-checklist.md);
  [`.cursor/skills/run-ledger-task-cursor/references/performance-evidence-checklist.md`](.cursor/skills/run-ledger-task-cursor/references/performance-evidence-checklist.md).
- OPT-134 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-135**.

### OPT-135 delivery (2026-09-14T13:58:00Z)

- Implemented host `target_guard_v2` keep policy: frozen target/guard roles,
  one-sided df=9 paired-rate bounds, per-pair decode p95 ITL checks, and
  verdict precedence (incomplete, reject, inconclusive, keep). Exposed pure
  `evaluate(contract, records)` plus CLI self-check; added opt-in schema
  validation in `run_optimization_task.py` without changing legacy contracts.
  Identical skill checklist links and testing-strategy scope note; no CUDA,
  production pin, or historical fixture rewrite.
- Verification **PASS** (2026-09-14T14:00:00Z): ruff format/check clean;
  `60 passed`; 23/23 self-check cases `ok`; independent recomputation of
  neutral-guard keep, guard-loss reject, and straddling CI inconclusive cases
  matches fixture expectations; OPT-130 counterfactual preserves historical
  `reject`; skill checklists identical.
- Throughput delta: **N/A** (policy only; OPT-130 remains rejected).
- Key evidence: [`tasks/OPT-135.md`](tasks/OPT-135.md);
...
### OPT-139 delivery (2026-09-14T23:36:43Z)

- Implemented `opt139_counter_identity.py` phased NCU collector/reporter with
  structured CSV parsing, production kernel identity authentication for D128
  (`warp_query_decode_attention`) and D2048 (`vec128_online_decode_attention`),
  throughput-only admission rejection, prefill decode-attention ineligibility
  until OPT-140, and OPT-138 `run_counters` / `_experiment_entry` wiring.
  No production kernel or selector changes.
- Verification **PASS** (2026-09-14T23:36:21Z): ruff format/check clean
  (OPT-139 scope); **28 passed**; D128/D2048 identity authenticated against
  production traces; typed per-launch counters populated; mechanism admission
  `throughput_alone_cannot_establish_mechanism`; `supported_mechanism=null`;
  `candidate=null`; `git diff --check` pass.
- Candidate measured delta: **N/A**; shipping delta: **N/A**; quality result:
  **N/A**; mechanism: **explicitly unknown** (throughput alone rejected).
- Key evidence: [`tasks/OPT-139.md`](tasks/OPT-139.md);
  [`tools/opt139_counter_identity.py`](tools/opt139_counter_identity.py);
...
- OPT-139 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-140**.

### OPT-140 delivery (2026-09-15T00:07:46Z)

- Implemented `opt140_prefill_attention_replay.py` phased P4096 prompt-attention
  replay with production-boundary manifest, 16-layer output/KV parity under
  existing abs 2e-3, decode-attention substitution rejection, bounded NCU typed
  counters for `fattn_mma_pipeline_opt111_base`, and component-replay /
  scheduler wiring. No production kernel or selector changes.
- Verification **PASS** (2026-09-15T00:06:52Z): ruff check clean (OPT-140 scope);
  **35 passed**; 16/16 layer parity (`max_abs=0`); complete family boundary;
  OPT-139 launch identity retained; decode-attention substitution rejected;
  `supported_mechanism=null`; `candidate=null`; `git diff --check` pass.
- Candidate measured delta: **N/A**; shipping delta: **N/A**; quality result:
  **N/A**; mechanism: **explicitly unknown** (throughput alone rejected).
- Key evidence: [`tasks/OPT-140.md`](tasks/OPT-140.md);
  [`tools/opt140_prefill_attention_replay.py`](tools/opt140_prefill_attention_replay.py);
...
- OPT-140 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-141** (also **OPT-142** independently eligible).

### OPT-141 delivery (2026-09-15T00:32:00Z)

- Implemented `opt141_matched_llama_counters.py` phased llama NCU counter collection
  for the four OPT-138 gap-family selections with authenticated launch mappings,
  bounded per-kernel NCU replay, diagnosed NVTX/`mul_mat_q<` filter retry, typed
  counter evidence, and Quartz-vs-llama comparisons with fusion-boundary rejection.
  No production kernel or selector changes.
- Verification **PASS** (2026-09-15T00:31:30Z): ruff check clean (OPT-141 scope);
  **29 passed**; all four selections `matched`; six identity rows authenticated;
  five kernel collections (+ residual D2048 reuse); independent raw-report inspection
  for decode D128 and prefill P4096 attn; `supported_mechanism=null`; `candidate=null`;
  `git diff --check` pass.
- Candidate measured delta: **N/A**; shipping delta: **N/A**; quality result:
  **N/A**; mechanism: **explicitly unknown** (throughput alone rejected).
- Key evidence: [`tasks/OPT-141.md`](tasks/OPT-141.md);
  [`tools/opt141_matched_llama_counters.py`](tools/opt141_matched_llama_counters.py);
...
- OPT-141 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-142** (independently eligible) and **OPT-143** (after OPT-141 dependency
  satisfied).

### OPT-142 delivery (2026-09-15T00:51:00Z)

- Implemented `opt142_wall_reconciliation.py` phased whole-wall reconciliation on
  retained OPT-138 traces: reproduced legacy family-sum residual (23.61% decode /
  5.87% prefill on D2048 middle / P4096 r0), diagnosed bookkeeping fault (family
  overlap, window endpoints outside profiler, host nameId), corrected partition with
  GPU union / host exclusive / unresolved process gap, and per-window evidence for
  21 Quartz windows. No production scheduling, selector, or kernel changes.
- Verification **PASS** (2026-09-15T00:51:00Z): ruff check clean (OPT-142 scope);
  **54 passed**; coverage validation `valid` (21 windows); max Quartz unresolved
  share 0.00266 (limit 0.05); disjoint Q-L wall-gap residual 0; independent raw
  interval reconstruction; `git diff --check` pass.
- Candidate measured delta: **N/A**; shipping delta: **N/A**; quality result:
  **N/A**; family rankings separately qualified (not redistributed).
- Key evidence: [`tasks/OPT-142.md`](tasks/OPT-142.md);
  [`tools/opt142_wall_reconciliation.py`](tools/opt142_wall_reconciliation.py);
...
- OPT-142 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-143** (OPT-141 dependency satisfied); **OPT-146** blocked on OPT-143–145.

### OPT-143 delivery (2026-09-15T01:05:00Z)

- Implemented `opt143_short_attention.py` phased short-decode attention
  keep/reject evaluation: freeze from OPT-138/139/141 evidence, measured
  `no_opportunity` (no source-grounded mechanism for D2048 `vec128_online`
  attn_core; occupancy/DRAM alone cannot freeze; warp_query rejected as D2048
  evidence). Quality wired for arithmetic candidates but short-circuited with
  `nll_required=false` when no candidate frozen. Parent retained; no production
  kernel or selector change.
- Verification **PASS** (2026-09-15T01:05:00Z): ruff check clean (OPT-143 scope);
  **41 passed**; `candidate_nll_not_measured=false` on quality skip;
...
- Key evidence: [`tasks/OPT-143.md`](tasks/OPT-143.md);
  [`tools/opt143_short_attention.py`](tools/opt143_short_attention.py);
...
- OPT-143 marked `done`. Coupled IDs: none. Next eligible pending task:
  **OPT-144** (OPT-143 dependency satisfied); **OPT-146** blocked on OPT-144–145.

### OPT-144 delivery (2026-09-15T01:13:26Z)

- Implemented `opt144_prefill_attention.py` phased P4096 prefill attention
  keep/reject evaluation: freeze from OPT-138/140/141 evidence, measured
  `no_opportunity` (no source-grounded mechanism for P4096 `opt111_base`
  attn_core; occupancy/DRAM/tensor counters alone cannot freeze; decode NCU
  rejected as prefill evidence; OPT-141 fused-boundary mismatch 16×2 vs 8×8).
  Quality wired for arithmetic candidates but short-circuited with
  `nll_required=false` when no candidate frozen. Parent retained; no production
  kernel or selector change.
- Verification **PASS** (2026-09-15T01:13:26Z): ruff check clean (OPT-144 scope);
  **38 passed**; `candidate_nll_not_measured=false` on quality skip;
  freeze/report verdict `no_opportunity`; parent retained; shipping delta 0.
- Candidate measured delta: **N/A**; shipping delta: **0**; quality result:
  **nll_not_required_no_arithmetic_change**.
- Key evidence: [`tasks/OPT-144.md`](tasks/OPT-144.md);
  [`tools/opt144_prefill_attention.py`](tools/opt144_prefill_attention.py);
...
### OPT-146 delivery (2026-09-15T02:15:00Z)

- Implemented `opt146_batch_reconciliation.py` phased final batch reconciliation:
  fresh matched Quartz vs llama throughput (D128/D2048/D8192/D32768
  decode_only+complete_request and P4096 prefill; 3 warmups + 10 alternating
  pairs), OPT-142 wall reconciliation on fresh captures (21/21 windows ≤0.26%
  unresolved), OPT-143/144/145 experiment summaries, top-two family excess,
  and next-experiment specs with `candidate=null` and resolving measurements
  pointing at prior `no_opportunity` results. OPT-137 control reconstructed as
  current production; historical OPT-137 rates not presented as paired gain.
  Parent retained; no production kernel or selector change.
- Verification **PASS** (2026-09-15T02:15:00Z): ruff check clean (OPT-146
  scope); **53 passed** (OPT-146 + OPT-142–145 peers); coverage valid
  (21 windows); independent D2048 decode_only mean and D2048 middle r0 wall
  reconstructed from raw artifacts; net batch shipping delta 0.
- Candidate measured delta: **0**; shipping delta: **0**; quality result:
  **N/A** (diagnostics only).
- Fresh Quartz/llama gaps (informational): D2048 decode_only 50.06 vs 69.56
  tok/s; P4096 prefill 2996.22 vs 3223.78 tok/s.
- Key evidence: [`tasks/OPT-146.md`](tasks/OPT-146.md);
  [`tools/opt146_batch_reconciliation.py`](tools/opt146_batch_reconciliation.py);
...
### OPT-150–152 task authoring (2026-09-15T10:33:54Z)

Documentation only, requested closer alignment with pinned llama attention.
All three tasks are pending; no kernel, selector or historical verdict changed.

- OPT-150 authenticates the current baseline and resolves source/report
  discrepancies. OPT-137's score is scalar QK plus a zero-weight MMA result;
  weighted V is scalar. Compiled behavior and cost attribution require evidence.
- OPT-151 implements actual QK and PV MMA using the pinned GQA/tile organization
  while retaining authoritative BF16 state, checkpoint format and reserve.
- OPT-152 reuses OPT-148 to screen wider vector coverage. Current production
  verified_max=4096 leaves positions 4097–8191 on warp_query; coverage is not
  already continuous to 8192. Llama selects using padded used K.ne[1], whereas
  Quartz thresholds use position, so equal numeric thresholds are not parity.
- Historical correction context: OPT-129's ~0.050 ms at 8192 is a BF16
  llama-vector adapter, not selected native MMA. OPT-136's D32768 ~0.24 ratio
  is pre-137 whole-engine decode throughput, not a current component result.
