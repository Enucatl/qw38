...
| OPT-092 | Group same-input Q8 decode projections into one launch per layer group | OPT-091 | in_progress | Exact staging/output parity and full mixer plus two-prefix E2E acceptance, or retain r1_w4 separate launches | [`tasks/OPT-092.md`](tasks/OPT-092.md) |
