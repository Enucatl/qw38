...
| OPT-142 | Reconcile remaining whole-wall profiling residual | OPT-138 | in_progress | Required decode windows and P4096 reconcile within 5% with explicit overlap, host/idle and unmatched accounting | [`tasks/OPT-142.md`](tasks/OPT-142.md) |
