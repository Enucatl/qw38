...
51. [Synchronized runtime timing and NVTX attribution](51-runtime-timing-and-nvtx.md): asynchronous launches, CUDA events, CPU clocks, named ranges, decode and 2K prefill attribution, mixer-projection MMQ versus gdn_core/attention_core, exclusive decode mixer_mmv/gdn_core/attention_core/ffn_mmv categories, remainder other/idle, unavailable boundaries, overhead, and profiler limits.
