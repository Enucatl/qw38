...
42. [Chunked CUDA GDN prefill](42-cuda-gdn-chunks.md): token-major chunks, strict recurrence order, 64-token windows, associative overlay scan, warp-column fused quality production, sequential reference, candidate continuity, cancellation, and token-wise equivalence.
