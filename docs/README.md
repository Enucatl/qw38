...
6. [CUDA decode and prefill](06-system-optimization.md): MMV, MMQ, GDN, attention, mixer/FFN MMA, GDN/attention core quality, mixer Q8 quality / shared residual Y, skinny-M mixer dispatch, and the 4K keep/reject oracle.
