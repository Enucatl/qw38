...
53. [Stable-address CUDA graphs](53-stable-address-cuda-graphs.md): capture, instantiate, upload, replay, pointer lifetime, decode and 4,096-row prompt FFN graphs, PDL forbidden during FFN capture, dynamic exclusions, equality, launch attribution, and graph memory.
