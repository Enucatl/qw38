...
43. [CUDA grouped-query attention decode](43-cuda-attention-decode.md): heads and KV sharing, normalization, partial RoPE, BF16 cache rows, causal stable softmax, candidate commit, one-token KV partitions with FP32 partial merge, independent D128/D2048 selection, and frozen numeric gates.
