...
[Index](README.md) · Implementation tasks: MEM-001, MEM-002, OPT-008, and EDU-036 in
...
| Explicit Quartz total | 29,560,766,304 | Model + session + workspace + graphs |
| Allocator delta | 4,882,592 | CUDA delta not assigned to explicit owners |
...
Before graph creation, 3,580,100,608 bytes were free. After uploading the graph
executables, 3,573,809,152 bytes were free; their difference is the measured
6,291,456-byte graph allocation.

## Reserve result

The device exposes 33,671,348,224 total bytes. With every owner and graph alive,
3,573,809,152 bytes remained free. The required reserve is 1,610,612,736 bytes
(1.5 GiB), leaving a margin of **1,963,196,416 bytes**.

Process resident host memory measured 19,114,786,816 bytes. Host RSS is not VRAM
...
OPT-008's 4,096-row allocation, are admitted
