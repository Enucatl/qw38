...
### Integration tests
Authoritative model prompt→prefill→128 decode continuation; snapshot at chunk boundary/restore; behavioral smoke/long-context where feasible.
## Benchmark required
