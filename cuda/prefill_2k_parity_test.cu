...
int main(int argc, char** argv) {
  ...
  for (int replicate = 0; replicate < kReplicates; ++replicate) {
    ...
    if (session.frontier() != kPromptTokens ||
      ...
      std::fprintf(stderr, "2K parity session is incomplete\n");
      return 1;
    }
  }
  ...
  std::printf(
      "QW38_PREFILL_2K_PARITY_RESULT={\"schema_version\":1,\"task\":\"OPT-016\","
      ...
      "\"attribution\":null,\"nsight_systems\":\"not_used\","
      "\"nsight_compute\":\"not_used\",\"q4_decode\":\"%s\","
      "\"attention_pipeline\":\"%s\","
      ...
      mean_tok_s, qw38::cuda::effective_q4_decode_path(),
