...
constexpr char kPrefix[] = "QW38_OPT038_PREFILL_ATTRIBUTION_RESULT=";
...
int main(int argc, char** argv) {
  ...
  if (!measured || attribution.prompt_tokens != kPromptTokens ||
    ...
    std::fprintf(stderr, "OPT-038 4K prefill attribution record is incomplete\n");
    return 1;
  }
  ...
  std::printf(
      "%s{\"schema_version\":1,\"task\":\"OPT-038\",\"status\":\"measured\","
